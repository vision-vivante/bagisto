<section class="max-w-screen-xl mx-auto px-4 py-16 md:py-32">
  ...
  @forelse($spa_products as $spa_product)

  <a href="{{ route('shop.product_or_category.index',$spa_product->url_key) }}"
